" VIM cs file
" Simple color scheme for C++

" Author: Yongjin Kim
" Date: 2014-07-14
" NOTE: 
" - This color scheme works best with background = 235.
" - Use RGB code number 16 or higher only.

highlight clear

let g:colors_name = "yjsimple"
let save_cpo = &cpo
set cpo&vim
...
" RGB map for 256 colors.
" URL: http://www.calmar.ws/vim/256-xterm-24bit-rgb-color-chart.html
let s:rgb_map = {
  \ 'NONE': 'NONE', 0: "#000000",
  \ 1: "#800000", 2: "#008000", 3: "#808000", 4: "#000080", 5: "#800080",
  \ 6: "#008080", 7: "#C0C0C0", 8: "#808080", 9: "#FF0000", 10: "#00FF00",
  \ 11: "#FFFF00", 12: "#0000FF", 13: "#FF00FF", 14: "#00FFFF", 15: "#FFFFFF",
...
call s:hi('Comment', 78, '', '')
call s:hi('Number', 1, '', 'bold')
call s:hi('StorageClass', 39, '', 'bold')
call s:hi('Constant', 147, '', '')
call s:hi('Todo', 16, 208, 'bold')
call s:hi('LineNr', 195, '', '')
